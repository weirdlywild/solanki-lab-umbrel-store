...
|---|---|---|---|---|
| [Browser Use](https://github.com/imamousenotacat/re-browser-use) | `solanki-lab-browser-use` | 0.9.9 | `ghcr.io/weirdlywild/solanki-lab-browser-use` (self-built) | AI browser automation MCP server (re-browser-use fork) |
